...
const STREAM='https://artemis.streamerr.co/listen/radio_freccia_nera__lounge/radio.mp3';
...
const Help={canHandle:h=>Alexa.getRequestType(h.requestEnvelope)==='IntentRequest'&&['AMAZON.HelpIntent','AMAZON.FallbackIntent'].includes(Alexa.getIntentName(h.requestEnvelope)),handle:h=>h.responseBuilder.speak(isIT(h)?'Di: Alexa, apri Freccia Nera Lounge.':'Say: Alexa, open Freccia Nera Lounge.').getResponse()};
